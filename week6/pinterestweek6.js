var createCard = function(columnFive) {
    var card = $('<div class="my-card"> <img class="my-image" src="https://s-media-cache-ak0.pinimg.com/236x/7c/5d/86/7c5d86128f6cf83a60c562d86e18f32c.jpg"> <button class="pinit">Pin It</button><div class="my-caption"> <p class="p-textbox">Nature scene</p> </div> <div class="my-avatar"> <img src="http://www.annaakullian.com/static/images/yoga.jpg"> </div> <div> <p class="user-name">Anna Akullian</p> <p class="p-board-category">Nature</p> </div> </div>');
...
$(document).ready(function(event) {
    ...
    // $('.my-card').on('mouseover', function(event) {
    ...
    function() {
     ...
     function() {
        ...
        // $(this).children('.my-image').toggleAttr('display', 'none');
    // });
